...
export function IconPayroll({ className }: { className?: string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="20"
...
export function IconDeliveries({ className }: { className?: string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="20"
...
export function IconInstallation({ className }: { className?: string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="20"
...
const NAV_ICONS: Record<string, React.ComponentType<{ className?: string }>> = {
  ...
  "/dashboard/installation-services": IconInstallation,
};

export function getNavIcon(href: string) {
  return NAV_ICONS[href] ?? IconDashboard;
}
